...
var admin = /** @class */ (function (_super) {
    ...
    function admin(id, userName, password, role) {
        return _super.call(this, id, userName, password, role) || this;
    }
    admin.prototype.banUser = function (user) {
        user.status = "banned";
        console.log("Tai khoan ".concat(user.userName, " da bi khoa"));
    };
    return admin;
}(Account));
var admin1 = new admin(99, "Admin", "admin123", "admin");
